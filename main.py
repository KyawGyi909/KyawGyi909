...
import os
token = '7503216125:AAHV1tzsoM7WKz56ZhcbLaKRh1GYt09Bqs4'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '7275888505'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '7275888505':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription ")
		return
